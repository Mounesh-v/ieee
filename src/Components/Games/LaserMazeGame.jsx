  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center text-white overflow-hidden">
      ...
      <div className="relative z-10 text-center">
        <h1 className="text-6xl font-extrabold mb-3 text-yellow-400 drop-shadow-[0_0_25px_rgba(255,255,0,0.9)]">
          LASER MAZE GAME
        </h1>

        <h2 className="text-2xl mb-4 font-semibold">Level {level + 1}</h2>
        ...
        <div className="flex flex-col lg:flex-row gap-10 items-center justify-center">
          {/* GRID */}
          <div className="bg-gray-800/80 backdrop-blur-xl p-6 rounded-2xl shadow-[0_0_40px_rgba(0,255,255,0.3)]">
                ...
                [...Array(GRID_SIZE)].map((_, col) => {
                  ...
                  return (
                    <div
                      ...
                      ${row === 9 && col === 9 ? "bg-green-600 shadow-[0_0_15px_lime]" : ""}
                    ...
                    >
                      ...
                      {isBomb && "💣"}
                      {mirrors[key] === "slash" && (
                        <div className="rotate-45 text-cyan-300 text-xl drop-shadow-[0_0_10px_cyan]">
                          /
                        </div>
                      )}
          ...
          {/* CONTROLS PANEL */}
          <div className="bg-gray-900/80 backdrop-blur-xl p-8 rounded-2xl w-72 shadow-[0_0_40px_rgba(0,255,0,0.2)]">
            <h3 className="text-2xl mb-6 font-bold">Add Mirrors</h3>

            <div className="flex justify-center gap-6 mb-6">
              <button
                onClick={() => setSelectedMirror("slash")}
                className="bg-gray-700 hover:bg-gray-600 px-6 py-3 rounded-lg text-xl"
              >
                /
              </button>
            ...
            <button
              onClick={reset}
              className="bg-gray-700 hover:bg-gray-600 w-full py-3 rounded-lg mb-6"
            >
              Reset
            </button>

            <button onClick={exitBtn} className="bg-red-700 hover:bg-red-600 w-full py-3 rounded-lg mb-6">Exit</button>

            {won && (
              <>
                <p className="text-green-400 text-xl mb-4 drop-shadow-[0_0_10px_lime]">
                  You Win! 🎉
                </p>
                <button
                  onClick={nextLevel}
                  className="bg-green-500 hover:bg-green-600 w-full py-3 rounded-lg shadow-[0_0_15px_lime]"
                >
                  Next Level
                </button>
              </>
